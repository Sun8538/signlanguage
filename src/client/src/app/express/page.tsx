...
export default function Home() {
  ...
  useEffect(() => {
    ...
    socket.on("E-ANIMATION", (animations) => {
      console.log("Received animations:", animations.length, "words");
      console.log("First animation sample:", animations[0]);
      // if (duration != "0") {
      //   setSigningSpeed(
  ...
  function getNextWord(): string | null {
    ...
    console.log("Playing animation for:", animation[0], "with", animation[1]?.length, "frames");
